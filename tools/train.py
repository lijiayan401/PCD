...
if __name__ == "__main__":
    ...
    if args.logit_stand and cfg.DISTILLER.TYPE in ['KD', 'DKD', 'MLKD', 'PCD', 'SWAP', 'RC', 'MLKD_NOAUG']:
        ...
        elif cfg.DISTILLER.TYPE == 'PCD':
            cfg.PCD.ALPHA = cfg.PCD.ALPHA * args.kd_weight
            cfg.PCD.T = args.base_temp
    ...
    if cfg.DISTILLER.TYPE in ['PCD']:
        cfg.EXPERIMENT.TAG += ',t=' + str(cfg.PCD.T)
        cfg.EXPERIMENT.TAG += ',alpha=' + str(cfg.PCD.ALPHA)
        cfg.EXPERIMENT.TAG += ',steps=' + str(cfg.PCD.STEPS)
